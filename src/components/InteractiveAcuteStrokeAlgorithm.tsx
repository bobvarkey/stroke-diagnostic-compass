            ...
            <div className="mb-6 p-4 bg-gradient-to-r from-emerald-100 to-teal-100 dark:from-emerald-900/40 dark:to-teal-900/40 border border-emerald-300 dark:border-emerald-700 rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 text-sm">
                ...
                <div className="p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30 border border-green-300 dark:border-green-700 rounded-lg">
                  ...
                  {/* Detailed EVT Decision Tree */}
                  <div className="mt-4 space-y-3">
                    <h5 className="font-semibold text-sm text-green-800 dark:text-green-300">Detailed EVT Eligibility by Population</h5>
                    
                    {/* Header Row */}
                    <div className="grid grid-cols-6 gap-1 text-[10px] sm:text-xs font-bold text-center">
                      <div className="p-1.5 bg-green-200 dark:bg-green-800 rounded">Population</div>
                      <div className="p-1.5 bg-green-200 dark:bg-green-800 rounded">Vessel Occlusion</div>
                      <div className="p-1.5 bg-green-200 dark:bg-green-800 rounded">Time from Onset</div>
                      <div className="p-1.5 bg-green-200 dark:bg-green-800 rounded">Tissue Injury</div>
                      <div className="p-1.5 bg-green-200 dark:bg-green-800 rounded">Baseline Function</div>
                      <div className="p-1.5 bg-green-200 dark:bg-green-800 rounded">Evidence for EVT</div>
                    </div>

                    {/* Neonates ≤28 days */}
                    <div className="grid grid-cols-6 gap-1 text-[10px] sm:text-xs text-center items-stretch">
                      <div className="p-1.5 bg-purple-100 dark:bg-purple-900/40 rounded font-medium">≤28 days</div>
                      <div className="p-1.5 bg-white/70 dark:bg-gray-800/70 rounded">LVO*</div>
                      <div className="p-1.5 bg-white/70 dark:bg-gray-800/70 rounded">0–24 h</div>
                      <div className="p-1.5 bg-white/70 dark:bg-gray-800/70 rounded">—</div>
                      <div className="p-1.5 bg-white/70 dark:bg-gray-800/70 rounded">—</div>
                      <div className="p-1.5 bg-yellow-100 dark:bg-yellow-900/40 rounded font-semibold text-yellow-800 dark:text-yellow-300">IDD</div>
                    </div>

                    {/* 28 days – 5 years */}
                    <div className="grid grid-cols-6 gap-1 text-[10px] sm:text-xs text-center items-stretch">
                      <div className="p-1.5 bg-purple-100 dark:bg-purple-900/40 rounded font-medium">28 days–5 yrs</div>
                      <div className="p-1.5 bg-white/70 dark:bg-gray-800/70 rounded">LVO*</div>
                      <div className="p-1.5 bg-white/70 dark:bg-gray-800/70 rounded">0–24 h</div>
                      <div className="p-1.5 bg-white/70 dark:bg-gray-800/70 rounded">Salvageable Brain Tissue</div>
                      <div className="p-1.5 bg-white/70 dark:bg-gray-800/70 rounded">—</div>
                      <div className="p-1.5 bg-green-100 dark:bg-green-900/40 rounded font-semibold text-green-800 dark:text-green-300">EVT ✓</div>
                    </div>

                    {/* 6–17 years */}
                    <div className="border border-border rounded-lg overflow-hidden">
                      <div className="p-1.5 bg-purple-100 dark:bg-purple-900/40 text-center font-medium text-[10px] sm:text-xs">6–17 years — LVO*</div>
                      <div className="divide-y divide-border">
                        <div className="grid grid-cols-4 gap-1 p-1 text-[10px] sm:text-xs text-center">
                          <div className="p-1 bg-white/70 dark:bg-gray-800/70 rounded">0–6 h</div>
                          <div className="p-1 bg-white/70 dark:bg-gray-800/70 rounded">Salvageable Brain Tissue</div>
                          <div className="p-1 bg-white/70 dark:bg-gray-800/70 rounded">—</div>
                          <div className="p-1 bg-green-100 dark:bg-green-900/40 rounded font-semibold text-green-800 dark:text-green-300">EVT ✓</div>
                        </div>
                        <div className="grid grid-cols-4 gap-1 p-1 text-[10px] sm:text-xs text-center">
                          <div className="p-1 bg-white/70 dark:bg-gray-800/70 rounded">6–24 h</div>
                          <div className="p-1 bg-white/70 dark:bg-gray-800/70 rounded">Salvageable Brain Tissue</div>
                          <div className="p-1 bg-white/70 dark:bg-gray-800/70 rounded">—</div>
                          <div className="p-1 bg-green-100 dark:bg-green-900/40 rounded font-semibold text-green-800 dark:text-green-300">EVT ✓</div>
                        </div>
                        <div className="grid grid-cols-4 gap-1 p-1 text-[10px] sm:text-xs text-center">
                          <div className="p-1 bg-white/70 dark:bg-gray-800/70 rounded">&gt;24 h</div>
                          <div className="p-1 bg-white/70 dark:bg-gray-800/70 rounded">—</div>
                          <div className="p-1 bg-white/70 dark:bg-gray-800/70 rounded">—</div>
                          <div className="p-1 bg-yellow-100 dark:bg-yellow-900/40 rounded font-semibold text-yellow-800 dark:text-yellow-300">IDD</div>
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Adults ≥18 years — LVO */}
                    <div className="border border-border rounded-lg overflow-hidden">
                      <div className="p-1.5 bg-blue-100 dark:bg-blue-900/40 text-center font-medium text-[10px] sm:text-xs">≥18 years — LVO* (ICA, M1, dominant M2)</div>
                      <div className="divide-y divide-border text-[10px] sm:text-xs">
                        {/* 0-6h */}
                        <div className="p-1.5 bg-blue-50/50 dark:bg-blue-950/20 font-semibold text-center">0–6 h</div>
                        {/* ASPECTS 6-10 */}
                        <div className="pl-3 p-1 bg-white/50 dark:bg-gray-900/50">
                          <p className="font-medium mb-1">ASPECTS 6–10</p>
                          <div className="grid grid-cols-2 gap-1">
                            <div className="p-1 rounded bg-green-100 dark:bg-green-900/40 text-center">mRS 0–1 → <span className="font-bold text-green-800 dark:text-green-300">EVT ✓</span></div>
                            <div className="p-1 rounded bg-green-100 dark:bg-green-900/40 text-center">mRS 2 → <span className="font-bold text-green-800 dark:text-green-300">EVT ✓</span></div>
                            <div className="p-1 rounded bg-green-100 dark:bg-green-900/40 text-center">mRS 3–4 → <span className="font-bold text-green-800 dark:text-green-300">EVT ✓</span></div>
                            <div className="p-1 rounded bg-yellow-100 dark:bg-yellow-900/40 text-center">mRS &gt;4 → <span className="font-bold text-yellow-800 dark:text-yellow-300">IDD</span></div>
                          </div>
                        </div>
                        {/* ASPECTS 3-5 */}
                        <div className="pl-3 p-1 bg-white/50 dark:bg-gray-900/50">
                          <p className="font-medium mb-1">ASPECTS 3–5</p>
                          <div className="grid grid-cols-2 gap-1">
                            <div className="p-1 rounded bg-green-100 dark:bg-green-900/40 text-center">mRS 0–1 → <span className="font-bold text-green-800 dark:text-green-300">EVT ✓</span></div>
                            <div className="p-1 rounded bg-yellow-100 dark:bg-yellow-900/40 text-center">mRS ≥2 → <span className="font-bold text-yellow-800 dark:text-yellow-300">IDD</span></div>
                          </div>
                        </div>
                        {/* ASPECTS 0-2 */}
                        <div className="pl-3 p-1 bg-white/50 dark:bg-gray-900/50">
                          <p className="font-medium mb-1">ASPECTS 0–2</p>
                          <div className="grid grid-cols-2 gap-1">
                            <div className="p-1 rounded bg-green-100 dark:bg-green-900/40 text-center">mRS 0–1 → <span className="font-bold text-green-800 dark:text-green-300">EVT ✓</span></div>
                            <div className="p-1 rounded bg-yellow-100 dark:bg-yellow-900/40 text-center">mRS ≥2 → <span className="font-bold text-yellow-800 dark:text-yellow-300">IDD</span></div>
                          </div>
                        ...
                        {/* 6-24h */}
                        <div className="p-1.5 bg-blue-50/50 dark:bg-blue-950/20 font-semibold text-center">6–24 h</div>
                        <div className="pl-3 p-1 bg-white/50 dark:bg-gray-900/50">
                          <p className="font-medium mb-1">ASPECTS 6–10</p>
                          <div className="grid grid-cols-2 gap-1">
                            <div className="p-1 rounded bg-green-100 dark:bg-green-900/40 text-center">mRS 0–1 → <span className="font-bold text-green-800 dark:text-green-300">EVT ✓</span></div>
                        ...
                        <div className="p-1.5 text-center">
                          <span>&gt;24 h → </span><span className="font-bold text-yellow-800 dark:text-yellow-300">IDD</span>
                        </div>
                      </div>
                    </div>
                    ...
                    {/* MVO Dominant M2 */}
                    <div className="border border-border rounded-lg overflow-hidden">
                      <div className="p-1.5 bg-orange-100 dark:bg-orange-900/40 text-center font-medium text-[10px] sm:text-xs">≥18 years — MVO (Dominant M2)</div>
                      <div className="divide-y divide-border text-[10px] sm:text-xs">
                        <div className="pl-3 p-1 bg-white/50 dark:bg-gray-900/50">
                          <p className="font-medium mb-1">0–6 h · ASPECTS 6–10 · mRS 0–1</p>
                          <div className="p-1 rounded bg-green-100 dark:bg-green-900/40 text-center font-bold text-green-800 dark:text-green-300">EVT ✓</div>
                        </div>
                        <div className="p-1.5 text-center">
                          <span>&gt;6 h → </span><span className="font-bold text-yellow-800 dark:text-yellow-300">IDD</span>
                        </div>
                      </div>
                    </div>

                    {/* MVO Non-dominant M2 / DVO */}
                    <div className="grid grid-cols-6 gap-1 text-[10px] sm:text-xs text-center items-stretch">
                      <div className="p-1.5 bg-orange-100 dark:bg-orange-900/40 rounded font-medium col-span-2">MVO (Non-dominant M2) or DVO</div>
                      <div className="p-1.5 bg-white/70 dark:bg-gray-800/70 rounded">0–24 h</div>
                      <div className="p-1.5 bg-white/70 dark:bg-gray-800/70 rounded">—</div>
                      <div className="p-1.5 bg-white/70 dark:bg-gray-800/70 rounded">—</div>
                      <div className="p-1.5 bg-red-100 dark:bg-red-900/40 rounded font-semibold text-red-800 dark:text-red-300">No EVT ✗</div>
                    </div>

                    {/* Basilar Artery */}
                    <div className="border border-border rounded-lg overflow-hidden">
                      <div className="p-1.5 bg-indigo-100 dark:bg-indigo-900/40 text-center font-medium text-[10px] sm:text-xs">≥18 years — Basilar Artery</div>
                      <div className="divide-y divide-border text-[10px] sm:text-xs">
                        <div className="pl-3 p-1 bg-white/50 dark:bg-gray-900/50">
                          <p className="font-medium mb-1">0–24 h · PC-ASPECTS ≥6 · mRS 0–1</p>
                          <div className="grid grid-cols-2 gap-1">
                            <div className="p-1 rounded bg-green-100 dark:bg-green-900/40 text-center">NIHSS ≥10 → <span className="font-bold text-green-800 dark:text-green-300">EVT ✓</span></div>
                            <div className="p-1 rounded bg-green-100 dark:bg-green-900/40 text-center">NIHSS 6–9 → <span className="font-bold text-green-800 dark:text-green-300">EVT ✓</span></div>
                          </div>
                        </div>
                        <div className="p-1.5 text-center">
                          <span>mRS ≥2 → </span><span className="font-bold text-yellow-800 dark:text-yellow-300">IDD</span>
                        </div>
                      </div>
                    </div>
                  </div>
