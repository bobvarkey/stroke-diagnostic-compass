...
export default function StrokeWorkupChecklist({ patient, onPatientDataChange }: StrokeWorkupChecklistProps) {
  ...
  return (
    <div className="min-h-screen bg-black max-w-6xl mx-auto px-[max(0.75rem,env(safe-area-inset-left))] sm:px-4 md:px-6 py-4 pb-[calc(6rem+env(safe-area-inset-bottom))] sm:pb-4 space-y-5">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsList className="hidden sm:grid w-full grid-cols-9 h-auto sticky top-0 z-40 mb-5 rounded-xl p-1.5 gap-1.5 bg-gradient-to-r from-background/95 via-card/90 to-background/95 backdrop-blur-xl border border-border/60 shadow-lg shadow-primary/5">
          ...
          <TabsTrigger value="hemorrhagic" className="flex items-center justify-center gap-1.5 text-[13px] font-bold tracking-tight text-amber-700 dark:text-amber-300 bg-amber-500/10 hover:bg-amber-500/20 ring-1 ring-inset ring-amber-500/30 data-[state=active]:text-white data-[state=active]:bg-gradient-to-br data-[state=active]:from-amber-500 data-[state=active]:to-orange-500 data-[state=active]:ring-transparent data-[state=active]:shadow-md data-[state=active]:shadow-amber-500/40 data-[state=active]:scale-[1.03] px-2.5 py-2.5 rounded-lg transition-all">
            <Droplets className="h-4 w-4 shrink-0" />
            ICH
          </TabsTrigger>
          <TabsTrigger value="sah" className="flex items-center justify-center gap-1.5 text-[13px] font-bold tracking-tight text-red-700 dark:text-red-300 bg-red-500/10 hover:bg-red-500/20 ring-1 ring-inset ring-red-500/30 data-[state=active]:text-white data-[state=active]:bg-gradient-to-br data-[state=active]:from-red-500 data-[state=active]:to-rose-500 data-[state=active]:ring-transparent data-[state=active]:shadow-md data-[state=active]:shadow-red-500/40 data-[state=active]:scale-[1.03] px-2.5 py-2.5 rounded-lg transition-all">
            <Droplets className="h-4 w-4 shrink-0" />
            SAH
          </TabsTrigger>
          <TabsTrigger value="sdh" className="flex items-center justify-center gap-1.5 text-[13px] font-bold tracking-tight text-orange-700 dark:text-orange-300 bg-orange-500/10 hover:bg-orange-500/20 ring-1 ring-inset ring-orange-500/30 data-[state=active]:text-white data-[state=active]:bg-gradient-to-br data-[state=active]:from-orange-500 data-[state=active]:to-amber-500 data-[state=active]:ring-transparent data-[state=active]:shadow-md data-[state=active]:shadow-orange-500/40 data-[state=active]:scale-[1.03] px-2.5 py-2.5 rounded-lg transition-all">
            <Layers className="h-4 w-4 shrink-0" />
            SDH
          </TabsTrigger>
          <TabsTrigger value="cvt" className="flex items-center justify-center gap-1.5 text-[13px] font-bold tracking-tight text-purple-700 dark:text-purple-300 bg-purple-500/10 hover:bg-purple-500/20 ring-1 ring-inset ring-purple-500/30 data-[state=active]:text-white data-[state=active]:bg-gradient-to-br data-[state=active]:from-purple-500 data-[state=active]:to-fuchsia-500 data-[state=active]:ring-transparent data-[state=active]:shadow-md data-[state=active]:shadow-purple-500/40 data-[state=active]:scale-[1.03] px-2.5 py-2.5 rounded-lg transition-all">
            <Brain className="h-4 w-4 shrink-0" />
            CVT
          </TabsTrigger>
          <TabsTrigger value="post-ivt" className="flex items-center justify-center gap-1.5 text-[13px] font-bold tracking-tight text-rose-700 dark:text-rose-300 bg-rose-500/10 hover:bg-rose-500/20 ring-1 ring-inset ring-rose-500/30 data-[state=active]:text-white data-[state=active]:bg-gradient-to-br data-[state=active]:from-rose-500 data-[state=active]:to-pink-500 data-[state=active]:ring-transparent data-[state=active]:shadow-md data-[state=active]:shadow-rose-500/40 data-[state=active]:scale-[1.03] px-2.5 py-2.5 rounded-lg transition-all">
